...
<p color="#8b949e">Olá! Me chamo Vinícius Freitas, tenho 20 anos e moro em Registro/SP. Atualmente estou cursando Ensino Superior em Desenvolvimento de Software Multiplataforma na FATEC Registro. Sou focado e apaixonado pela área de Back-End e Banco de Dados, onde busco sempre evoluir minhas habilidades para construir soluções robustas e eficientes. 🚀🛠️</p>

* 🎓 **Formação:** Cursando Desenvolvimento de Software Multiplataforma na **FATEC**.
* ⚙️ **Foco:** Dedicado totalmente à área de **Back-End**.
* 🚀 **Projetos:** Desenvolvimento e integração de **APIs**.
* 🗄️ **Banco de Dados:** Voltado ao estudo e gerenciamento de sistemas de armazenamento estruturados e NoSQL.
---
...
<p align="center">
  <img src="https://raw.githubusercontent.com/zFreitaz/zFreitaz/output/github-contribution-grid-snake.svg" alt="Cobrinha do GitHub Zelda Edition" />
</p>
